...
public class NguoiDungExcelExporter extends AbstractExporter{
	...
	private void writeHeaderLine() {
		...
		createCell(row, 0, "Ma TK", cellStyle);
		createCell(row, 1, "E-mail", cellStyle);
		createCell(row, 2, "Ho", cellStyle);
		createCell(row, 3, "Ten", cellStyle);
		createCell(row, 4, "Chuc Vu", cellStyle);
		createCell(row, 5, "Trang thai", cellStyle);
	}
